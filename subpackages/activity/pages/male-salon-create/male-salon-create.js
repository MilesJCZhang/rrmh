// subpackages/activity/pages/male-salon-create/male-salon-create.js
// 男推荐官沙龙创建页 - 独立页面，蓝色商务风，类型自动锁定为 male_salon
...
Page({
  ...
  async loadSalonData(id) {
    try {
      ...
      console.error('[male-salon-create] loadSalonData error:', err);
    ...
    wx.chooseImage({
      ...
      success: (res) => {
        ...
        uploadFile(tempPath, 'image').then((data) => {
          ...
          console.warn('[male-salon-create] cover upload failed:', err);
          // 上传失败也保留本地预览
